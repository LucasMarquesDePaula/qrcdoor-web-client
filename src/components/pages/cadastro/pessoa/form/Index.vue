          ...
          <md-layout :md-gutter="true">
            <md-layout md-flex="50">
              <md-input-container :class="{ 'md-input-invalid': $v.model.nome.$error }">
                ...
                <span class="md-error" v-show="$v.model.nome.minLength">Valor muito curto</span>
              </md-input-container>
            </md-layout>
            ...
            <md-layout md-flex="25">
              <md-input-container :class="{ 'md-input-invalid': $v.model.situacao.$error }">
                ...
                <span class="md-error" v-show="$v.model.situacao.required">Valor Obrigatório</span>
              </md-input-container>
            </md-layout>
            ...
            <md-layout md-flex="25">
              <md-input-container :class="{ 'md-input-invalid': $v.model.role.$error }">
                ...
                <span class="md-error" v-show="$v.model.role.required">Valor Obrigatório</span>
              </md-input-container>
            </md-layout>
          </md-layout>
        </md-layout>
